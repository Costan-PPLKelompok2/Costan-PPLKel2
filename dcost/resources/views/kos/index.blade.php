<x-app-layout>
    ...
    <style>
        ...
        .total-kos-card:hover {
            border-color: #0a58ca;
        }
        .total-penghuni-card {
            border-left: 5px solid #198754;
        }
        .total-penghuni-card:hover {
            border-color: #146c43;
        }
        ...
        @media (max-width: 991.98px) {
            ...
            .add-kos-button, .sort-button, .filter-button {
                width: 100%;
            }
            .input-group {
                flex-direction: column;
        ...
        .btn-link.text-warning:hover { color: #d0a301 !important; }
        .btn-link.text-danger:hover { color: #a62632 !important; }
        .btn-link.text-info:hover { color: #127a8b !important; }
    </style>
</x-app-layout>
